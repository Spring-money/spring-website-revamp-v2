            ...
            <div className={style.leftMiddlePannel}>
                ...
                <div className={style.middlePannel}>
                        ...
                        <div className={style.topHead}>
                            ...
                            <div>
                                <div className={style.text1}>
                                    <span>My Guide 2 Wealth</span>
                                </div>
                                <div className={style.text2}>
                                    <span>Principal Advisor: Joseph Robbins</span>
                                </div>
                    ...
                    <div className={style.middleTextConatinerText2} style={{ marginBottom: '1.25vw' }}>
                        <span>
                        The Idea of starting MyGuide2Wealth is based on assisting people with their financial goals keeping in mind their best interests. Our financial advise is totally factored on you and not on selling financial services of our interest . Our methods are unique by systematically creating strategies that best fit your needs ; wherein commissions and hidden fees are strict NO for us. As an affordable fee only planner , our financial advise and the benefits that accrue to you surpasses much more than the sum you pay us.
                        </span>
                    </div>
