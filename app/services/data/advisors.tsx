  ...
  | "Professionals";
   ...
   export const advisors: Advisor[] = [
     ...
     /* ----------------------- Advisor 8 ----------------------- */
     {
      ...
      "tagline": "Money should support the life you truly want to live, and not the other way around.",
      ...
      "about": "Rahul believes that financial plans should be \"life-shaped\"®️. He specializes in helping couples make better money decisions through authentic and empathetic conversations. His approach goes beyond mere spreadsheets, focusing on creating plans that align finances with shared dreams and support both partners. This ensures their financial future is not only looks good on paper but feels right in real life.",
      "description": "Meet Rahul, the founder of Advent Financial.\n\nHe believes financial planning should truly reflect your life.\n\nBecause, too often, the advice focuses only on numbers, not people.\n\nIt's usually technical, impersonal, and overlooks that real life involves two people navigating shared dreams and different perspectives on money.\n\nRahul has seen the impact of couples struggling with money talks, or plans that look good on paper but don't fit real life.\n\nThat's why he created Advent Financial:\n\nto offer empathetic advice, rooted in real conversations, and designed to support both partners.\n\nRahul is a Certified Financial Planner® (CFP®) and a Registered Life Planner (RLP®).\n\nMore importantly, he prioritizes understanding you before offering any advice.\n\nBecause your plan shouldn't just look good on paper; it should feel right in real life.",
      "services":[
        {
      ...
      "cta": [
        ...
        },
        {
          ...
          "href": "https://www.linkedin.com/in/rahul121/",
          "variant": "secondary"
        }
      ],
      "clientTypePills": [
