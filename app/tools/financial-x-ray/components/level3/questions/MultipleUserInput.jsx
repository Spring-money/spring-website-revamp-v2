...
function MultipleUserInput(props) {

    let nextquestionDetails;
    let options = props.questionDetails.options;
    let arr = [];
    ...
    function selectHandler(event) {
        ...
        // we have selected the option and set the optionSelected but haven't changed the options which is needed to be done on clicking next question
    }
                            ...
                            <>
                                {
                                    optionSelected[index] ?
                                        <Option key={'options' + index}
                                            className={"bg-gray-950 text-white hover:bg-gray-950 hover:text-white"}
                                            data-id={index}
                                            onClick={selectHandler}>{data.option_text}</Option> :
                                        <Option key={'options' + index}
                                            data-id={index}
                                            onClick={selectHandler}>{data.option_text}</Option>
                                }
